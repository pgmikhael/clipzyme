...
@register_object("ema", "callback")
class EMA(pl.Callback, Nox):
    ...
    def __init__(self, args) -> None:
        ...
        pin_memory = not args.ema_dont_pin_memory
    ...
    def add_args(parser) -> None:
        parser.add_argument(
            ...
            type=float,
            default=0.9999,
            help="Decay rate for EMA weights",
        )
        parser.add_argument(
            "--ema_device",
            type=str,
            default=None,
            help="Device to store EMA weights. If None, use the same device as the model",
        )
        parser.add_argument(
            "--ema_dont_pin_memory",
            action="store_true",
            default=False,
            help="Do not pin memory for EMA weights.",
        )
