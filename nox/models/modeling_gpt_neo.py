...
class GPTNeoSelfAttention(nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None, start_causal_index=None):
        ...
        # if conditioning on prompt, start causal modeling after start_causal_index
        if start_causal_index is not None:
            causal_mask[...,:start_causal_index] = 1
    ...
    def forward(
        ...
        attn_output, attn_weights = self._attn(query, key, value, attention_mask, head_mask, start_causal_index)
...
class GPTNeoModel(GPTNeoPreTrainedModel):
    ...
    def forward(
        ...
        start_causal_index: Optional[int]=None
